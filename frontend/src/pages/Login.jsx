...
const submitHandler = async (event) => {
  ...
  return (
    <section className="flex justify-center items-center h-screen">
      <div className="w-fullmax-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
        ...
        <form className="py-4 md:py-0" onSubmit={submitHandler}>
          <div className="mb-5">
            ...
            className="w-[400px]  py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor rounded-md cursor-pointer"
            required
            />
          ...
          <p className="mt-5 text-textColor text-center">Don't have a account .<Link to='/register' className='text-primaryColor font-medium'>Register</Link></p>
