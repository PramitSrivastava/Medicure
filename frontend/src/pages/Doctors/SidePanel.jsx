    ...
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
      ...
      <div className='mt-[30px]'>
        ...
        <ul className='mt-3'>
          ...
          <li className='flex items-center justify-between mb-2'>
            <p className='text-[15px] leading-6 text-textColor font-semibold'>Wesnesday</p>
            <p className='text-[15px] leading-6 text-textColor font-semibold'>2:00 PM - 9:30 PM</p>
          </li>
        </ul>
      </div>
